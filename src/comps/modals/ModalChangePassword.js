...
function ModalChangePassword(props) {
    ...
    const [oldPasswShow, setOldPasswShow] = useState(false);
    const [newPassw, setNewPassw] = useState(null);
    const [newPasswShow, setNewPasswShow] = useState(false);
    const [newPasswRep, setNewPasswRep] = useState(null);
    const [newPasswRepShow, setNewPasswRepShow] = useState(false);
    ...
    async function handleSave() {
        ...
        if (newPassw !== newPasswRep) {
            setErrorMsg("Make sure to repeat new password correctly");
            return null;
        }
        setIsSending(true);
        let resp = await doReq();
        if (!resp.ok) {
            setErrorMsg("Old password provided isn't correct");
            setIsSending(false);
        } else {
    ...
    async function doReq() {
        ...
        form.set('old_password', oldPassw);
        form.set('new_password', newPassw);
                    ...
                    <ul>
                        <li>
                            <div class="modal-account-inp">
                                ...
                                <input type={oldPasswShow ? "text" : "password"} value={oldPassw} placeholder="Old password" onChange={(evt) => setOldPassw(evt.target.value)} />
                                <div class="passw-symb" onClick={() => setOldPasswShow(prevState => !prevState)}>
                                    <PasswSymb show={oldPasswShow}/>
                                </div>
                            </div>
                        </li>
                        <li>
                            <div class="modal-account-inp">
                                ...
                                <input type={newPasswShow ? "text" : "password"} value={newPassw} placeholder="New password" onChange={(evt) => setNewPassw(evt.target.value)} />
                                <div class="passw-symb" onClick={() => setNewPasswShow(prevState => !prevState)}>
                                    <PasswSymb show={newPasswShow}/>
                                </div>
                            </div>
                        </li>
                        <li>
                            <div class="modal-account-inp">
                                ...
                                <input type={newPasswRepShow ? "text" : "password"} value={newPasswRep} placeholder="Repeat new password" onChange={(evt) => setNewPasswRep(evt.target.value)} />
                                <div class="passw-symb" onClick={() => setNewPasswRepShow(prevState => !prevState)}>
                                    <PasswSymb show={newPasswRepShow}/>
                                </div>
                            </div>
                        </li>
                        <li>
